...
const Notification = ({ toggleDropdown }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className="w-full fixed z-10 right-0 h-full overflow-x-hidden top-0 transform translate-x-0 transition ease-in-out duration-700"
          id="notification"
        >
          <div className="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 fixed right-0 top-0 shadow-3xl">
              ...
              <div className="pl-3 w-full">
                <div className="flex items-center justify-between w-full">
                  <p
                    ...
                    className="focus:outline-none text-sm leading-none"
                  >
                    <span className="text-indigo-700">Sash</span> added you to
                    the group:{" "}
