      ...
      <div className="section__container">
        ...
        <div className="article__cards">
          <Article
            ...
            articleWriteup={
              "In the last 10 years Americans have seen a boom in local food markets and for good reason. While Americans continue to buy more fast food, they still expect perf......"
            }
            articleViews={35}
            articleLikes={567}
            articleComments={7}
